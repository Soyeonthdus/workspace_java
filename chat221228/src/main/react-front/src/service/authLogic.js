...
class AuthLogic {
  ...
  constructor() {
    ...
    this.googleProvider = new GoogleAuthProvider(); //구글 객체사용을 위한 인증
  }
  //로그인 시도시 구글인증인지 아니면 깃헙인증인지 문자열로 넘겨받음
  //구글 인증인 경우 - Google
  //깃허브 인증인 경우 - Github
  //로그인 메소드
  login(providerName) {
...
/* 외부 js에서 열 수 있다 = 외부 js에서 사용하려면 반드시 추가할 것*/
/* 왜 리덕스를 공부해야하나? 에 대한 대답 */
