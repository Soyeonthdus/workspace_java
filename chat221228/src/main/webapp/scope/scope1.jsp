...
<%
	...
	out.print("<h3>"+himCar.toString()+"</h3>"); //toString() 주소값
	out.print("<h3>"+herCar.toString()+"</h3>");
	out.print("<h3>"+yourCar.toString()+"</h3>");
	out.print("<h3>"+myCar.toString()+"</h3>");
	request.setAttribute("myCar", myCar); //request
	pageContext.setAttribute("herCar", herCar); //page
	session.setAttribute("yourCar", yourCar); //session
%>
