...
/*
  ...
  또 다른 이유로는 Hibernate와 같은 또 다른 솔루션으로 커스터마이징하거나 리펙토링시에 독립적인
  ...
  서비스 계층에 해당되는 클래스 반드시 분리할 수 있는 독립된 클래스여야함
...
public class Board1Logic {
	...
	public List<Map<String, Object>> getBoardList() {
		...
		//List<Map<String, Object>> boardList = null; null초기화가 맞지만 아직 허접이므로 쓰지말자
